...
-addext "subjectAltName = DNS:minio-api.minio-ns.svc, DNS:minio-console-minio-ns.apps.cnsa.cr.cnaf.infn.it, DNS:minio-0, DNS:minio-api-minio-ns.apps.cnsa.cr.cnaf.infn.it"
